...
//--------------------------------------------------------
const MaterialInput = ({ error, value, onChangeText, onBlur, width, iconName, label, keyboardType, textAlign,autoFocus, ...props }) => (
    <Item inlineLabel
        ...
        <Input value={value} {...props}
            ...
            onBlur={onBlur} keyboardType={keyboardType}
